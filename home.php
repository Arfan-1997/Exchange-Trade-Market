...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    <a href="signin.php">Sell the product</a>
...
<div id="signin">
    <a  href="signin.php" data-lightbox="si" >Login</a>
     ...
     <body>
        <div>
            ...
            <div class="container">
                ...
                <form class="mb-0" method="post" name="search" action="signin.php">
